...
class LoadJobData extends AbstractFixture implements OrderedFixtureInterface
{
    public function load(ObjectManager $em)
    {
        ...
        $job_sensio_labs->setExpiresAtValue(new \DateTime('2012-10-10'));
        ...
        $job_extreme_sensio->setExpiresAtValue(new \DateTime('2012-10-10'));
        ...
        $job_expired->setCreatedAtValue(new \DateTime('2005-12-01'));
